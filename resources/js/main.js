...
//user click on the buttom
// if there is any text in the text file then will be added to the to do list
...
let completeSVG = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22 22" style="enable-background:new 0 0 22 22;" xml:space="preserve"><style type="text/css">.st0{fill:none;}.st1{fill:#26B999;}</style><rect y="0" class="nofill" width="22" height="22"/><g><path class="fill" d="M9.7,14.4L9.7,14.4c-0.2,0-0.4-0.1-0.5-0.2l-2.7-2.7c-0.3-0.3-0.3-0.8,0-1.1s0.8-0.3,1.1,0l2.1,2.1l4.8-4.8c0.3-0.3,0.8-0.3,1.1,0s0.3,0.8,0,1.1l-5.3,5.3C10.1,14.3,9.9,14.4,9.7,14.4z"/></g></svg>';
...
for(let j=0; j<data.complete.length; j++){
  ...
  addItemToDo(text, true);
  }
}

//updatig the data of the items
...
// buttons functinality functions
...
//check if the item is compleated or todo
...
function addItemToDo(text, comp){
  let list = (comp) ? document.getElementById('complete'):document.getElementById('todo');
